...
\NewDocumentCommand\ParseShape{m}
{
    ...
    {% yes m-parameter found
        ...
        % clean the Shape
        \tl_replace_once:NVn \l__Shape_tl \l__ShapeMandatoryPar_tl {}
        
        \tl_regex_replace_once:Nnn \l__ShapeMandatoryPar_tl {\{} {}
        \tl_regex_replace_once:Nnn \l__ShapeMandatoryPar_tl {\}} {}

        % \tl_replace_all:Nnn \l__ShapeMandatoryPar_tl {\{} {}
        % \tl_replace_all:Nnn \l__ShapeMandatoryPar_tl {\}} {}
        
        %\tl_set:Ne \l__ShapeMandatoryPar_tl {\use:n \l__ShapeMandatoryPar_tl}
    ...
    {% yes O-parameter found
        ...
        % clean the Shape
        \tl_replace_once:NVn \l__Shape_tl \l__ShapeOptionPar_tl {}
        
        \tl_replace_all:Nnn \l__ShapeOptionPar_tl {[}{}
        \tl_replace_all:Nnn \l__ShapeOptionPar_tl {]}{}
    }
            % Trace
            \iow_term:n {ParseShape-extract m-parameter}
