...
\NewDocumentCommand\note{mmm}{\def\mytext{\textcolor{#1}{\textbf{#2}}}\comparestrict\ifthenelse{#3 = -2}{\DDC{\mytext}}{}\ifthenelse {#3 = -1}{\DC{\mytext}}{}\ifthenelse {#3 = 0}{\UL{\mytext}}{}\ifthenelse {#3 = 1}{\UC{\mytext}}{}\ifthenelse {#3 = 2}{\DUC{\mytext}}{}\ifthenelse {#3 = 9}{\mytext}{}}
...
% Usage \ST{B}{M}{H}[scale] - draw a stack of 3 notes
...
% usage: \CH{note F}{note T}{note Q}{F or T or Q}[scale]  - Triple 
\NewDocumentCommand\CH{mmmm O{1.0}}{\ifthenelse{\equal{#4}{F}}{\ST{\FU{#1}[#5]}{#2}{#3}}{}\ifthenelse{\equal{#4}{T}}{\ST{#2}{#3}{\FU{#1}[#5]}}{}\ifthenelse{\equal{#4}{Q}}{\ST{#3}{\FU{#1}[#5]}{#2}}{}}
