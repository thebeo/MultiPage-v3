...
\begin{document}
	...
	%\Pages{../datatest-data/test.txt}
	%\Pages{../datatest-data/multi-test.txt}
	
	%\Pages{../datatest-data/note-test.txt}
	%\Pages{../datatest-data/chord-test.txt}
	%\Pages{../datatest-data/shape-test.txt}
	%\Pages{../datatest-data/oo-test.txt}
	%\Pages{../datatest-data/master-test.txt}
	
		
    %\Pages{../datamusique/itsumo.txt}
    %\Pages{../datamusique/Lucid Dream.txt}
